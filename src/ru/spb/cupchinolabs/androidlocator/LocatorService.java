...
public class LocatorService extends Service {
    ...
    private static final int WAIT_FOR_PROVIDER_TIMEOUT_IN_SEC = 20;
    ...
    public void onCreate() {
        ...
        timer.schedule(new LMSTimerTask(locator), 1000L, REPEAT_TASK_INTERVAL_IN_SEC * 1000L);
    }
    ...
    private static class LMSTimerTask extends TimerTask {
        ...
        public LMSTimerTask(Locator locator) {
